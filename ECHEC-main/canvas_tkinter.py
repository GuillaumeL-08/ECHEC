...
class Chess_UI:
    ...
    def __init__(self, root:Tk, board:Board, J_Blanc, J_Noir):  
        ...
        self.img_dict = {
            'p': ImageTk.PhotoImage(Image.open('img/img/pion_noir.png').resize((100, 100))),
            'b': ImageTk.PhotoImage(Image.open('img/img/fou_noir.png').resize((100, 100))),
            'q': ImageTk.PhotoImage(Image.open('img/img/reine_noire.png').resize((100, 100))),
            'k': ImageTk.PhotoImage(Image.open('img/img/roi_noir.png').resize((100, 100))),
            'n': ImageTk.PhotoImage(Image.open('img/img/cavalier_noir.png').resize((100, 100))),
            'r': ImageTk.PhotoImage(Image.open('img/img/tour_noire.png').resize((100, 100))),
            'P': ImageTk.PhotoImage(Image.open('img/img/pion_blanc.png').resize((100, 100))),
            'B': ImageTk.PhotoImage(Image.open('img/img/fou_blanc.png').resize((100, 100))),
            'Q': ImageTk.PhotoImage(Image.open('img/img/reine_blanche.png').resize((100, 100))),
            'K': ImageTk.PhotoImage(Image.open('img/img/roi_blanc.png').resize((100, 100))),
            'N': ImageTk.PhotoImage(Image.open('img/img/cavalier_blanc.png').resize((100, 100))),
            'R': ImageTk.PhotoImage(Image.open('img/img/tour_blanche.png').resize((100, 100))),
        }
        self.root = root
        self.board = board
        ...
        self.bg_img = Image.open('img/img/plateau.png')
