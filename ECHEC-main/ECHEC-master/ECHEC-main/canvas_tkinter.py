...
class Chess_UI:
    ...
    def __init__(self, root:Tk, board:Board, J_Blanc, J_Noir):  
        ...
        # Initialiser l'apprentissage pour les IA qui le supportent
        if hasattr(self.Joueur_Blanc, 'start_new_game'):
            self.Joueur_Blanc.start_new_game()
        if hasattr(self.Joueur_Noir, 'start_new_game'):
            self.Joueur_Noir.start_new_game()
